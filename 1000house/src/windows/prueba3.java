...
//		List<Offer> l = new ArrayList<Offer>();
		...
		for(int i = 0;i < 20;i++) {
			...
			app.getwaitoffers().add(offer1);
			app.getwaitoffers().add(offer2);			
		}
...
//		app.getwaitoffers().add(app.getwaitoffers().get(1));
		SeeOfferWindow w = new SeeOfferWindow(app.getwaitoffers(),1);
